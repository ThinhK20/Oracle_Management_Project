namespace Oracle_Company
{
	partial class NhanVien
	{
		...
		private void InitializeComponent()
		{
			...
			tabControl1.Size = new Size(1327, 764);
			...
			tabPage1.Size = new Size(1319, 731);
			tabPage1.TabIndex = 0;
			tabPage1.Text = "Xem";
			// 
			// tabControl2
			...
			button5.Location = new Point(347, 34);
			button5.Margin = new Padding(3, 4, 3, 4);
			button5.Name = "button5";
			button5.Size = new Size(207, 43);
			button5.TabIndex = 3;
			button5.Text = "Xem dữ liệu gốc";
			...
			dataGridView1.Location = new Point(7, 126);
			dataGridView1.Margin = new Padding(3, 4, 3, 4);
			dataGridView1.Name = "dataGridView1";
			dataGridView1.RowHeadersWidth = 51;
			dataGridView1.RowTemplate.Height = 25;
			dataGridView1.Size = new Size(1305, 567);
			...
			tabPage4.Size = new Size(1357, 698);
			tabPage4.TabIndex = 1;
			...
			tabPage5.Size = new Size(1357, 698);
			tabPage5.TabIndex = 2;
			...
			tabPage6.Size = new Size(1357, 698);
			tabPage6.TabIndex = 3;
			tabPage6.Text = "Đề Án";
			...
			tabPage2.Size = new Size(1319, 731);
			tabPage2.TabIndex = 1;
			tabPage2.Text = "Sửa";
			...
			textBox4.Location = new Point(753, 208);
			...
			textBox3.Location = new Point(896, 113);
			...
			label2.Location = new Point(872, 40);
			label2.Name = "label2";
			...
			button2.Location = new Point(943, 329);
			...
			// textBox2
			// 
			textBox2.Location = new Point(706, 25);
			textBox2.Margin = new Padding(3, 4, 3, 4);
			textBox2.Multiline = true;
			textBox2.Name = "textBox2";
			textBox2.Size = new Size(585, 357);
			textBox2.TabIndex = 6;
			...
			label1.Location = new Point(671, 576);
			label1.Name = "label1";
			...
			textBox1.Location = new Point(872, 564);
			...
			button3.Location = new Point(1163, 571);
			...
			dataGridView5.Size = new Size(664, 727);
			...
			button4.Location = new Point(701, 34);
			button4.Margin = new Padding(3, 4, 3, 4);
			button4.Name = "button4";
			button4.Size = new Size(207, 43);
			button4.TabIndex = 4;
			button4.Text = "Xem dữ liệu mã hóa";
