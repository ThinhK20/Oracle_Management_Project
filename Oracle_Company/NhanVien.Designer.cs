namespace Oracle_Company
{
	partial class NhanVien
	{
		...
		private void InitializeComponent()
		{
			...
			tabControl1.Size = new Size(1327, 395);
			...
			tabPage1.Size = new Size(1319, 362);
			tabPage1.TabIndex = 0;
			tabPage1.Text = "Xem";
			// 
			// tabControl2
			...
			dataGridView2.Size = new Size(1325, 331);
			...
			tabPage2.Size = new Size(1319, 362);
			tabPage2.TabIndex = 1;
			tabPage2.Text = "Sửa";
			// 
			// label3
			...
			label3.Location = new Point(981, 220);
			label3.Name = "label3";
			...
			textBox3.Location = new Point(602, 105);
			...
			label2.Location = new Point(578, 31);
			label2.Name = "label2";
			...
			button2.Location = new Point(647, 307);
			...
			// textBox2
			// 
			textBox2.Location = new Point(450, 0);
			textBox2.Margin = new Padding(3, 4, 3, 4);
			textBox2.Multiline = true;
			textBox2.Name = "textBox2";
			textBox2.Size = new Size(511, 361);
			textBox2.TabIndex = 6;
			// 
			// label1
			// 
			...
			label1.Location = new Point(1027, 31);
			label1.Name = "label1";
			...
			textBox1.Location = new Point(1003, 132);
			textBox1.Margin = new Padding(3, 4, 3, 4);
			textBox1.Multiline = true;
			textBox1.Name = "textBox1";
			textBox1.Size = new Size(275, 53);
			textBox1.TabIndex = 4;
			// 
			// button3
			// 
			...
			button3.Location = new Point(1081, 283);
			...
			tabPage7.Size = new Size(1319, 362);
			tabPage7.TabIndex = 2;
			...
			// button4
			// 
			button4.Location = new Point(1039, 3);
			...
			TBGrid.Location = new Point(0, 3);
			TBGrid.Name = "TBGrid";
			TBGrid.RowHeadersWidth = 51;
			TBGrid.RowTemplate.Height = 29;
			TBGrid.Size = new Size(1008, 363);
			TBGrid.TabIndex = 0;
			// 
			// button1
			// 
			...
			// NS
			// 
			NS.Location = new Point(1069, 51);
			NS.Name = "NS";
			NS.Size = new Size(123, 43);
			NS.TabIndex = 3;
			NS.Text = "Nhân sự";
			...
			// TC
			// 
			TC.Location = new Point(1069, 49);
			TC.Name = "TC";
			TC.Size = new Size(123, 43);
			TC.TabIndex = 4;
			TC.Text = "Tài chính";
			...
			// QLP
			// 
			QLP.Location = new Point(1069, 50);
			QLP.Name = "QLP";
			QLP.Size = new Size(123, 43);
			QLP.TabIndex = 5;
			...
			// qlda
			// 
			qlda.Location = new Point(1069, 51);
			qlda.Name = "qlda";
			qlda.Size = new Size(123, 43);
			qlda.TabIndex = 6;
			...
			// qlnv
			// 
			qlnv.Location = new Point(1057, 51);
			qlnv.Name = "qlnv";
			qlnv.Size = new Size(135, 43);
			qlnv.TabIndex = 7;
			...
			// TB
			// 
			TB.Location = new Point(851, 51);
			TB.Name = "TB";
			TB.Size = new Size(155, 43);
			TB.TabIndex = 8;
